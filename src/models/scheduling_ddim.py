...
class DDIMScheduler():
    ...
    def __init__(
        ...
        **kwargs,
        ...
        message = ("Please make sure to instantiate your scheduler with `prediction_type` instead. E.g. `scheduler = DDIMScheduler.from_pretrained(<model_id>, prediction_type='epsilon')`.")
